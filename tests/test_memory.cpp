...
int main()
{
    ...
    assert(invalid_read.error() == rv32::Trap::LoadAccessFault);
    ...
    assert(invalid_write.error() == rv32::Trap::StoreAccessFault);
    ...
    assert(misaligned_read.error() == rv32::Trap::LoadAddressMisaligned);
    ...
    assert(boundary_read.error() == rv32::Trap::LoadAccessFault);

    // ==================================================
    // Test 8: little-endian read16()
    // ==================================================

    assert(memory.write8(4, 0x34).has_value());
    assert(memory.write8(5, 0x12).has_value());
    ...
    assert(misaligned_write16.error() == rv32::Trap::StoreAddressMisaligned);
    ...
    auto boundary_write16 = boundary_write_memory.write16(16, 0x1234);
    assert(!boundary_write16.has_value());
    assert(boundary_write16.error() == rv32::Trap::StoreAccessFault);
    ...
    assert(misaligned_read32.error() == rv32::Trap::LoadAddressMisaligned);
    ...
    auto boundary_read32 = boundary_read32_memory.read32(16);
    assert(!boundary_read32.has_value());
    assert(boundary_read32.error() == rv32::Trap::LoadAccessFault);
    ...
    // ==================================================
    // Test 17: verify little-endian byte layout for write32
    // ==================================================
    ...
    auto misaligned_write32 = memory.write32(6, 0x12345678);
    assert(!misaligned_write32.has_value());
    assert(misaligned_write32.error() == rv32::Trap::StoreAddressMisaligned);
    ...
    auto boundary_write32 = boundary_write32_memory.write32(16, 0x12345678);
    assert(!boundary_write32.has_value());
    assert(boundary_write32.error() == rv32::Trap::StoreAccessFault);
